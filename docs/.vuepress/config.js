...
module.exports = {
  ...
  head: [
    ...
    ['link', { rel: 'apple-touch-icon', sizes: '72x72', href: `${Base_URL}/assets/vue-use-embed.png` }],
    ...
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: `${Base_URL}/assets/vue-use-embed.png` }],
